...
const aboutImg = '../images/pes_logo.png';
...
function showAbout() {
    ...
    Swal.fire({
        background: swalBackground,
        position: 'center',
        title: '<strong>PES Virtual Classroom System</strong>',
        imageAlt: 'PES-about',
        imageUrl: aboutImg,
        html: `
        <br/>
        <div id="about">
            <b><a href="https://pes.edu/" class="umami--click--github" target="_blank">Go to college</a></b> project
            <br/><br/>
            <button class="pulsate umami--click--sponsor" onclick="window.open('https://pes.edu/')"><i class="fas fa-heart" ></i>&nbsp;WebSite</button>
            <br /><br />
            Author:<a href="https://pes.edu/" class="umami--click--linkedin" target="_blank"> Harshitha</a>
        </div>
        `,
        showClass: {
            popup: 'animate__animated animate__fadeInDown',
